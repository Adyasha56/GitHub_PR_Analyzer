    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="p-6">
          ...
          <p className="text-3xl font-bold">{stats?.stats.totalAnalyses || 0}</p>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-3xl font-bold">{stats?.stats.completedAnalyses || 0}</p>
        </Card>
        ...
        <Card className="p-6">
          ...
          <p className="text-3xl font-bold">{stats?.stats.failedAnalyses || 0}</p>
        </Card>

        <Card className="p-6">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm text-muted-foreground">Unique Repos</span>
            <GitPullRequest className="w-5 h-5 text-blue-500" />
          </div>
          <p className="text-3xl font-bold">{stats?.stats.uniqueRepos || 0}</p>
        </Card>
      </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className="text-muted-foreground">#{analysis.prNumber}</span>
